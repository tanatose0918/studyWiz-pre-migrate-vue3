...
useHead({
  title: 'รวมบทความและรีวิวทั้งหมด - Studywiz',
  meta: [
    { name: 'description', content: 'คลังบทความ ข่าวสารประชาสัมพันธ์ และรีวิวจากนักเรียนทั้งหมดของ Studywiz' }
  ]
});
</script>
...
<template>
  <div class="py-12 sm:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <SectionHeading 
        badge="Archive Feed"
        title="รวมบทความและข่าวสารทั้งหมด"
        subtitle="เรื่องราวน่าสนใจ เทคนิคการเตรียมตัวสอบ และรีวิวจากผู้เรียนจริงในต่างแดน"
        align="left"
      />
